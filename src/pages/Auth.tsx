...
export default function Auth() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        // Use supabase directly to pass metadata
  ...
  return (
    <>
      <SEOHead
        title={isLogin ? "Login | Unheard Pages" : "Sign Up | Unheard Pages"}
        description="Access your account to manage stories and settings."
      />
