...
import { MessageCircle, Search, Sparkles, User, ShieldCheck } from "lucide-react";
                    ...
                    {loading ? (
                        ...
                        <div className="grid gap-6 max-w-4xl mx-auto">
                            {filteredPosts.map((post) => (
                                <PostCard key={post.id} post={post} isAdmin={isAdmin} onPublish={handlePublish} />
                            ))}
                        </div>
                    ) : (
...
const PostCard = ({ post, isAdmin, onPublish }: { post: CommunityPost, isAdmin: boolean, onPublish: (id: string, solution: string) => void }) => {
